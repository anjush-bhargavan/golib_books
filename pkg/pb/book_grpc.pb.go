...
const (
	BookServices_CreateBook_FullMethodName      = "/pb.BookServices/CreateBook"
...
type BookServicesClient interface {
	CreateBook(ctx context.Context, in *BookModel, opts ...grpc.CallOption) (*BookResponse, error)
...
func (c *bookServicesClient) CreateBook(ctx context.Context, in *BookModel, opts ...grpc.CallOption) (*BookResponse, error) {
	out := new(BookResponse)
	err := c.cc.Invoke(ctx, BookServices_CreateBook_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookServicesServer interface {
	CreateBook(context.Context, *BookModel) (*BookResponse, error)
...
func (UnimplementedBookServicesServer) CreateBook(context.Context, *BookModel) (*BookResponse, error) {
...
func _BookServices_CreateBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookServices_CreateBook_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServicesServer).CreateBook(ctx, req.(*BookModel))
	}
